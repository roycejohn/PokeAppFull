  ...
  if (loading) {
    return (
      <div className="flex flex-col min-h-screen justify-center items-center">
        ...
        <div className="p-10">
          <p className="text-center px-4 text-xs md:text-lg">
            Patience, it's the free version! While you wait, why not play
            <a href="/game/pokeboard" className="text-blue-500 underline hover:text-blue-700"> Poke Match</a> in the game section? 😄
          </p>
        </div>
      </div>
    );
